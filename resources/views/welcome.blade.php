    ...
    <div class="relative min-h-screen w-full flex items-center flex-col justify-center p-4 md:p-8 overflow-hidden">
        ...
        <div
            ...
            <div class="flex-1 text-center lg:text-left">
                ...
                <!-- Sub-headline -->
                <p class="text-base mb-6  mx-auto lg:mx-0 text-white/80">Step into the world of luxury at the ARADA
                    Roadshow in the heart of Germany. Meet with Dubai's leading property experts, and explore a
                    hand-picked portfolio of premium ARADA properties, from stylish apartments to exclusive penthouses.
                </p>
                <!-- Benefits -->
                ...
                <div class="">
                    <div class="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0 text-white/80">
                        ...
                        <div
                            ...
                            <p class="text-sm">📅 Dates: 4–5 October 2025</p>
                            <p class="text-xs text-white/60">📍 Location: Breidenbacher Hof, Dusseldorf</p>
                        </div>
                        <!-- Location 2 -->
                        <div
                            class="flex-1 p-2 rounded-lg border border-white/20 backdrop-filter backdrop-blur-sm bg-primary/20 text-center">
            ...
            <div class="w-full lg:w-1/3 p-6 md:p-8 rounded-2xl bg-white/10 backdrop-filter backdrop-blur-sm shadow-xl">
                ...
                <form id="bookingForm" class="space-y-4" action="{{ route('register.store') }}" method="POST">
                   ...
                   focus:outline-none focus:border-[#D1CCBD] transition-colors">
                            <option value="" disabled selected>City and Date of Visit</option>
                            <option value="2025-10-04 - (Dusseldorf)">Dusseldorf – 4 Oct 2025</option>
                            <option value="2025-10-05 - (Dusseldorf)">Dusseldorf – 5 Oct 2025</option>
                            <option value="2025-10-11 - (Munich)">Munich – 11 Oct 2025</option>
                            <option value="2025-10-12 - (Munich)">Munich – 12 Oct 2025</option>
                        </select>
                        <p class="mt-1 text-sm text-red-400 hidden" id="error-date">Please select a city and date of
                            visit.</p>
                    </div>
